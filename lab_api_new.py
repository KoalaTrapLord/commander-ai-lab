...
async def deck_gen_v3_status():
    ...
    return {
        ...
        'model': _deck_gen_v3.model if _deck_gen_v3 else None,
        'embeddings_loaded': (
...
def init_coach_service():
    ...
    try:
        ...
        _deck_gen_v3_error = f"Missing dependency: {e}. Run: pip install requests beautifulsoup4"
...
def main():
    ...
    log.info(f"  LM Studio:    http://192.168.0.240:1234")
