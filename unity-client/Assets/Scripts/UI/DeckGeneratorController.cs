...
namespace CommanderAILab.UI
{
    ...
    public class DeckGeneratorController : MonoBehaviour
    {
        ...
        // ── Helper Models ─────────────────────────────────────────────────
        [System.Serializable]
        private class PreconListWrapper
        {
            public List<string> precons;
        }
        ...
        private System.Collections.IEnumerator PollGenerate(string requestJson)
        {
            ...
            try
            {
                _lastResult = JsonConvert.DeserializeObject<DeckGenResponse>(resultJson);
            }
            catch (Exception e)
            {
